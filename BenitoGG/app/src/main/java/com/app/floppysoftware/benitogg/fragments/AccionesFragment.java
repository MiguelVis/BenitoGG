...
public class AccionesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boolean esTabletHorizontal = getResources().getBoolean(R.bool.isTablet) && !Preferencias.getVertical(getActivity());

        // Inflar el layout del fragment
        View v = inflater.inflate(esTabletHorizontal ? R.layout.fragment_acciones_tablet : R.layout.fragment_acciones, container, false);
